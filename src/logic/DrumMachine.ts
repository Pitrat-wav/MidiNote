...
export class DrumMachine {
    ...
    constructor() {
        // Research: Master bus compression (-24dB) and saturation for "glue effect"
        this.comp = new Tone.Compressor(-24, 4)
        this.shaper = new Tone.WaveShaper(this.makeDistortionCurve(20))
        this.shaper.oversample = '4x' // Research: Reduces aliasing
        ...
        // Route all drum outputs through master processing
    ...
    /**
     * Research: Soft Clipping Curve based on Math.tanh approximation
     */
