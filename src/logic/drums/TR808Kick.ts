...
export class TR808Kick {
    ...
    trigger(time: number, pitch: number, decay: number) {
        ...
        // 808 Kick Core: Bridged-T Network emulation (Self-oscillating resonant filter)
        // Mathematically modeled as a sine wave with specific envelopes
        ...
        // Pitch Envelope: Diode-induced frequency shift (Tonk)
        // Start high (2.5x base frequency) and drop quickly
        ...
        // Target 0.001 to avoid log(0) errors in Web Audio
