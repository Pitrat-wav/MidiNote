...
export class DrumMachine {
    ...
    constructor() {
        ...
        const cowbell808 = new TR808Cowbell(this.outputCowbell)
        ...
        this.kit909 = {
            ...
            hihatOpen: new TR808HiHat(this.outputOpenHat),
            clap: new TR808Clap(this.outputClap),
            cowbell: cowbell808 // 909 uses 808 cowbell or similar in many hybrid setups
        }
    }
    ...
    triggerDrum(drum: 'kick' | 'snare' | 'hihat' | 'hihatOpen' | 'clap' | 'cowbell', time: number, velocity: number = 0.8) {
        ...
        if (this.currentKit === '808') {
            switch (drum) {
                ...
                case 'hihat':
                    kit808.hihatOpen.stop(time); // Choking
            ...
            switch (drum) {
                ...
                case 'hihat':
                    kit909.hihatOpen.stop(time); // Choking
