...
export class TR909Kick {
    ...
    trigger(time: number, pitch: number, decay: number, velocity: number = 0.8) {
        ...
        // HPF > 1kHz to avoid phase trap (+/- 2% variance)
        ...
        // Ultra short envelope (10-20ms) for the click (+/- 2% variance)
