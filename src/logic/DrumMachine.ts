...
export class DrumMachine {
    ...
    constructor() {
        // Master Bus Processing as per research
        this.comp = new Tone.Compressor(-24, 4)
        // Shaper uses tanh approximation for analog-style saturation
        ...
        // Routing: All instruments -> Compressor -> Shaper (Glue) -> Output -> Destination
    ...
    /**
     * Research: Formula for soft clipping approximation
