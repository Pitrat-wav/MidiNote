...
export class TR909Snare {
    ...
    constructor(private destination: Tone.ToneAudioNode) {
        ...
        // Research: While 909 uses LFSR, standard white noise is sufficient
        // when filtered correctly in the browser context.
    ...
    trigger(time: number, pitch: number, snappy: number) {
        ...
        // Research: Pitch envelope (2x base to base in 50ms)
        ...
        // Research: HPF ~1000Hz (Phase Trap protection)
        const hpf = new Tone.Filter(1000, "highpass");

        // Research: LPF for Tone control (4000Hz - 8000Hz)
        ...
        // Research: Snappy decay ~0.3s (default)
