...
export class DrumMachine {
    ...
    constructor() {
        ...
        this.shaper.oversample = '4x' // Reduce aliasing as per research
        ...
        // Routing: Instruments -> Compressor -> Shaper -> Output -> Destination
        // This provides the "glue" and analog saturation effect described in the research.
