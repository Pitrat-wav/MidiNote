...
export class DrumMachine {
    ...
    constructor() {
        ...
        // Master Saturation (tanh-based soft clipping)
        ...
        // Master Chain: All drums -> Compressor -> Shaper (Glue) -> Output -> Destination
    ...
    private makeDistortionCurve(amount: number) {
        ...
        for (let i = 0; i < n_samples; ++i) {
            ...
            // tanh-like soft clipping formula
    ...
    triggerDrum(drum: 'kick' | 'snare' | 'hihat' | 'hihatOpen' | 'clap', time: number, velocity: number = 0.8) {
        ...
        if (this.currentKit === '808') {
            ...
            switch (drum) {
                ...
                case 'hihat':
                    kit909.hihat.trigger(time, false, p.pitch, p.decay);
                    break
                case 'hihatOpen':
                    kit909.hihatOpen.trigger(time, true, p.pitch, p.decay);
                    break
