...
export class TR808Snare {
    ...
    trigger(time: number, pitch: number, snappy: number) {
        // Research: pitch maps to tone balance here (balance between low and high modes)
        const toneBalance = pitch;

        // Research: 808 Membrane modes: ~238Hz and ~476Hz
        ...
        // Research: HPF ~1800Hz-2000Hz to prevent "Phase Trap"
