...
export class TR808Kick {
    ...
    trigger(time: number, pitch: number, decay: number) {
        // pitch: 0.5 -> ~52.5Hz, maps to 45-60Hz range per report
        const tune = 45 + pitch * 15;
        // decay: 0.5 -> 1.7s, maps to 0.4-3.0s range per report
        ...
        // This forms the characteristic 'tonk' click without extra oscillators.
