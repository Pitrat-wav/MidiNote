...
export class TR808Snare {
    ...
    trigger(time: number, pitch: number, snappy: number) {
        ...
        // 808 Membrane modes: Fixed frequencies at 238Hz and 476Hz
        ...
        masterTonalGain.gain.exponentialRampToValueAtTime(0.001, time + 0.2); // Tonal decay: 0.2s
        ...
        // snappy: 0.5 -> 0.325s, maps to 0.25-0.4s
