...
export class DrumMachine {
    ...
    constructor() {
        // Research: Global Saturation and Compression for "glue effect"
        this.comp = new Tone.Compressor(-24, 4)
        // Research: Soft Clipping (tanh) for analog-style saturation
        ...
        // Routing: Instruments -> Compressor -> WaveShaper -> Master Output -> Destination
    ...
    /**
     * Research: Creates a soft-clipping saturation curve based on tanh
     */
    ...
    triggerDrum(drum: 'kick' | 'snare' | 'hihat' | 'hihatOpen' | 'clap', time: number, velocity: number = 0.8) {
        ...
        if (this.currentKit === '808') {
            ...
            switch (drum) {
                ...
                case 'hihatOpen':
                    // In TR909, we'll reuse our 808-based analog hihat for now
