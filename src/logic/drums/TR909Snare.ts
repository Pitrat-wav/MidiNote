...
export class TR909Snare {
    ...
    constructor(private destination: Tone.ToneAudioNode) {
        ...
        // Research suggests standard white noise is sufficient for 909 Snappy in Web Audio
    ...
    trigger(time: number, pitch: number, snappy: number) {
        // Tonal Body: Dual triangle oscillators (fixed modes at 160Hz and 220Hz)
        const freq1 = 160;
        const freq2 = 220;
        ...
        // Pitch Sweep: From 2x frequency to base over 50ms
        ...
        tonalGain.gain.exponentialRampToValueAtTime(0.001, time + 0.2); // Tonal decay: 0.2s

        // Snappy Layer (Noise with LPF/HPF)
        const noiseSrc = new Tone.BufferSource(this.noiseBuffer);
        const hpf = new Tone.Filter(1000, "highpass");
        // Tone control: adjusts LPF from 4kHz to 8kHz
